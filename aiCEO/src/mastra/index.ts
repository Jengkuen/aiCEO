...
import { taskCoordinationWorkflow } from './workflows/task-coordination';
import { endToEndBusinessPlanningWorkflow } from './workflows/end-to-end-business-planning';
...
export const mastra = new Mastra({
  workflows: { 
    ...
    endToEndBusinessPlanningWorkflow 
  },
